...
```
    ...
    ##    <chr>       <chr>                                <dbl> <chr>                 
    ##  1 0500000US0… Autauga County, Alaba…               59285 *****                 
    ##  2 0500000US0… Baldwin County, Alaba…              239945 *****                 
    ##  3 0500000US0… Barbour County, Alaba…               24757 *****                 
    ##  4 0500000US0… Bibb County, Alabama                 22152 *****                 
    ##  5 0500000US0… Blount County, Alabama               59292 *****                 
    ##  6 0500000US0… Bullock County, Alaba…               10157 *****                 
    ##  7 0500000US0… Butler County, Alabama               18807 *****                 
    ##  8 0500000US0… Calhoun County, Alaba…              116141 *****                 
    ##  9 0500000US0… Chambers County, Alab…               34450 *****                 
    ## 10 0500000US0… Cherokee County, Alab…               25224 *****                 
    ## # ℹ 3,212 more rows
...
- Document your observations here.
  - Income appears to coorrelate with family size - higher income -\>
    larger family
  - However, larger families seem to also have larger confidence
    intervals, pointing to the fact that there are many reasons why
    families would grow
  - Larger confidence intervals could point to higher income
    inequality - in Nantucket, Hampshire, and Dukes county, for example.
- Can you confidently distinguish between household incomes in Suffolk
  county? Why or why not?
  - Not particularly. The more people in a household, the larger the
    confidence interval is - while you might be able to identify a trend
    you can’t confidently distinguish.
- Which counties have the widest confidence intervals?
  - Nantucket (Nantucket Island), Hampshire (UMass Amherst), Dukes
    (Martha’s Vineyard), Berkshire (the Berkshires)
...
- What does this *overall* trend tell you about the relative ease of
  ...
  - I glean that small and large(r) counties are different beasts, and
    that if a county has, for example, 1,000,000 people, depending on
    the goal of the analysis, you may need to break it up into
    meaningful chunks to be able to study it.
...
- This map looks at 2-person family standard error across the US (except
  for CT, which appears to be missing)
- Standard error appears to be highest in counties with low populations,
  and appears highest in the west half of the country for some reason
- I’d posit that this occurs due to those being some of the counties

...
- [Grading Rubric](#grading-rubric)
  ...
  - [Submission](#submission)
    ...
    - [**q5** You have access to a few other variables. Construct **at
      ...
      `LIGHTSPEED_VACUUM`?](#q5-you-have-access-to-a-few-other-variables-construct-at-least-three-visualizations-of-velocityvacuum-against-these-other-factors-are-there-other-patterns-in-the-data-that-might-help-explain-the-difference-between-michelsons-estimate-and-lightspeed_vacuum)
...
- Interestingly, when distinctness is poor (1), the mean velocity is
  closest to the real (vacuum) speed of light, and as distinctness goes
  up, the mean velocity gets further from the real value.
...
- Both the simulated and real datasets stay within about 200 m/s of the
  real answer
...
- In the real data, you can see Michelson dial in his estimates over
  time - estimates from early June vary far more than ones near the end
  of the month

- Michelson’s experiments are more grouped together by day - he clearly
  didn’t have time to work on this every day
...
```
    ...
    ## # A tibble: 100 × 6
    ##    Date                Distinctness  Temp Velocity VelocityVacuum MichelsonError
...
- For example, the most accurate (when accuracy means closest to the
  real estimate of the speed of light as measured in a vacuum) estimates
  were at distinctness 1, which Michelson perceived to be worst
...
- It’s important to keep in mind that this plot measures *error* only -
  the actual number is in the hundreds of thousands, therefore these
  errors are less than 0.5% off of the actual estimate

...
-   Are there any sources of *real* uncertainty in the percent occupied you calculated?
    -   No. The Islands is a computer program that can, at any time, indicate whether a house is occupied or not. The program could have a bug, but I don't think that counts here.
